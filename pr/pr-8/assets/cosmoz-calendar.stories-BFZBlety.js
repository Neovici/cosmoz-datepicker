	...
	>
		${rt(s,(z,w)=>`cal-${w}`,(z,w)=>[S`
					<div class="month-wrapper ${c>1?"padded":""}">
						${[lr({index:w,locale:r,numberOfMonths:c,selectedMonth:l,setSelectedMonth:p}),ar({endDate:e,focusedDate:n,locale:r,maxDate:a,minDate:o,month:z,numberOfMonths:c,onClick:d,onFocus:g,onKeyDown:f,onPointerDown:i,onPointerEnter:u,startDate:m,weekdayNames:k})]}
					</div>
