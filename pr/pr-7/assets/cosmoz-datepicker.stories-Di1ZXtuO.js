...
`;customElements.define("cosmoz-tooltip-content",I(()=>y`
			...
			<slot></slot>
		`,{styleSheets:[yt,Ne]}));const mt=K(F`
...
`,Ge=t=>L(()=>{if(t==null)return;const e=new RegExp(t,"u");return n=>{!n.defaultPrevented&&n.data&&!e.test(n.data)&&n.preventDefault()}},[t]),Ue=T(class extends C{values;constructor(t,e,n,r){super(t,e),Object.assign(e.host,n),this.values=r}update(t,e){this.hasChanged(e)&&(this.values=e,Object.assign(this.state.host,t))}hasChanged(t=[]){return t.some((e,n)=>this.values[n]!==e)}});T(class extends C{update(){return this.state.host}});const Qe=/([A-Z])/gu,Ot=(t,e,n)=>{t[e]=n,t.dispatchEvent(new CustomEvent(e.replace(Qe,"-$1").toLowerCase()+"-changed",{detail:{value:n}}))},re=t=>{const e=U(void 0),n=P(u=>e.current=u,[]),r=t.shadowRoot,o=P(u=>t.dispatchEvent(new Event(u.type,{bubbles:u.bubbles})),[]),a=P(u=>Ot(t,"value",u.target.value),[]),s=P(u=>Ot(t,"focused",u.type==="focus"),[]),i=P(()=>{const u=e.current?.checkValidity();return t.toggleAttribute("invalid",!u),u},[]);return Ue({validate:i},[i]),k(()=>{const u=g=>{g.composedPath()[0]?.closest?.("input, textarea")||(g.preventDefault(),e.current?.focus())};return r.addEventListener("mousedown",u),()=>r.removeEventListener("mousedown",u)},[]),{onChange:o,onFocus:s,onInput:a,onRef:n}},Xe=({placeholder:t})=>t||" ",Ve=(t,e)=>e??(t==="date"?"9999-12-31":void 0),Je=["type","variant","hint","compact","required","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",...ee],Ke=t=>{const{type:e="text",pattern:n,allowedPattern:r,autocomplete:o,value:a,readonly:s,disabled:i,min:u,max:g,step:p,maxlength:c,required:d}=t,{onChange:l,onFocus:f,onInput:h,onRef:m}=re(t),b=Ge(r);return t.toggleAttribute("has-value",!!a),te(y`
		...
		<slot name="suffix"></slot>
		${z(o,s=>y`<div class="failure">${s}</div>`)} `},on=F`
	.toggle {
		appearance: none;
